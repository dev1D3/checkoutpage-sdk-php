 ...
 * @method $this setForceAcsNewWindow(bool $bool) The forced display mode with the ACS page opening in a new window despite the settings in Checkout Page
 * @method $this setForcePaymentMethod(string $method) The ID of the payment provider that is opened to customers by default.
 * @method $this setLanguageCode(string $code) The language in which the checkout page will be opened to the customer in ISO 639-1 alpha-2 format.
 ...
 * @method $this setMode(string $mode) Checkout Page mode.
 ...
 * @method $this setRedirect(bool $bool) A parameter that enables opening of the generated checkout page in a separate tab
 ...
 * @method $this setRedirectOnMobile(bool $bool) A parameter that enables opening of the generated checkout page in a separate tab on mobile devices only
 ...
 * @method $this setTargetElement(string $target) The element in which the iframe of the checkout page is embedded in the web page of your project.
 * @method $this setTerminalId(int $id) Unique ID of the Checkout Page template which you want to run despite the regional and A/B test settings
 * @method $this setBaseurl(string $url) Basic Checkout Page address that is used in case the Checkout Page domain differs from the domain used to connect libraries or if merchant.js is not connected via the <script> tag
